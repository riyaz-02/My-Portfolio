...
function animateLoader(loader, startTime) {
  const totalHeight = document.body.scrollHeight; // Get the total height of the content
  ...
  if (percentage < 10) {
    ...
    setTimeout(function () {
      loader.remove(); // Remove the loader from the DOM after it has finished animating
